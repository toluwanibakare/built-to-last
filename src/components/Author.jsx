            ...
            >
              ...
              <div className="absolute bottom-4 right-4 flex flex-col items-center gap-2">
                <div className={`flex flex-col gap-2 transition-all duration-300 origin-bottom ${showSocials ? 'opacity-100 scale-100' : 'opacity-0 scale-50 pointer-events-none'}`}>
                  <a href={config.social.facebook} target="_blank" rel="noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-paper shadow-lg transition-transform hover:scale-110" aria-label="Facebook">
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                  <a href={config.social.instagram} target="_blank" rel="noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-paper shadow-lg transition-transform hover:scale-110" aria-label="Instagram">
                  ...
                  <a href={config.social.whatsapp} target="_blank" rel="noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-paper shadow-lg transition-transform hover:scale-110" aria-label="WhatsApp">
                  ...
                  <a href="mailto:voiceoftruthonline@gmail.com" className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-paper shadow-lg transition-transform hover:scale-110" aria-label="Email">
